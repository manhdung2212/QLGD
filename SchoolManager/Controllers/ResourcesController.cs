...
namespace SchoolManager.Controllers
{
    public class ResourcesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.listbuild = db.Buildings.ToList();
            return View();
        }
        [HttpPost]
        public PartialViewResult ListResource(string search, int pageNumber, int pageSize, int idbuildorroom, int searchstatus)
        {
            ...
            var data = (from r in db.Resources
                        join b in db.Buildings on r.IDBuildOrRoom equals b.ID
            ...
            //if (search.Trim() != "")
            //{
            //    data = data.Where(x => x.resource.Name.Contains(search)).OrderBy(x => x.resource.Name);
            //}
            if (idbuildorroom != 0)
            {
        ...
        //[HttpPost]
        //public JsonResult GetListBuildingOrRoom( int code )
        //{
        //    if( code == 1)
        //    {
        ...
        public PartialViewResult InfoDetail(int id)
        {
            ...
            Resource re = db.Resources.Find(id);
            ViewBag.listbuild = db.Buildings.ToList();
